...
REM
REM Generated by Vivado on Thu May 11 15:36:37 +0800 2023
...
echo "xvlog --incr --relax -prj tb_single_f2s_vlog.prj"
call xvlog  --incr --relax -prj tb_single_f2s_vlog.prj -log xvlog.log
