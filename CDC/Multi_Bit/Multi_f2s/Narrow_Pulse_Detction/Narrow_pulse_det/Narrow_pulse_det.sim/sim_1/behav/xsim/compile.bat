...
REM
REM Generated by Vivado on Thu Sep 01 10:11:44 +0800 2022
...
echo "xvlog --incr --relax -prj tb_Narrow_pulse_det_vlog.prj"
call xvlog  --incr --relax -prj tb_Narrow_pulse_det_vlog.prj -log xvlog.log
