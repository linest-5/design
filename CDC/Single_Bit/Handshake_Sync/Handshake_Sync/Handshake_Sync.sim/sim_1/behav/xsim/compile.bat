...
REM
REM Generated by Vivado on Thu May 11 15:55:12 +0800 2023
...
echo "xvlog --incr --relax -prj tb_Handshake_Sync_vlog.prj"
call xvlog  --incr --relax -prj tb_Handshake_Sync_vlog.prj -log xvlog.log
