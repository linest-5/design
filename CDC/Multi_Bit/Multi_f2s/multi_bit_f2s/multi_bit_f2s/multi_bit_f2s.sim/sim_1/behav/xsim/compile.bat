...
REM
REM Generated by Vivado on Thu Sep 01 11:46:34 +0800 2022
...
echo "xvlog --incr --relax -prj tb_multi_bit_f2s_vlog.prj"
call xvlog  --incr --relax -prj tb_multi_bit_f2s_vlog.prj -log xvlog.log
